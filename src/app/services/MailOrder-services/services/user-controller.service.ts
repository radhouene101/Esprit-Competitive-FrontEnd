...
export class UserControllerService extends BaseService {
  ...
  static readonly GetCurrentUserPath = '/user/current-user';
   ...
   * This method doesn't expect any request body.
   */
  getCurrentUser$Response(params?: GetCurrentUser$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDetails>> {
   ...
   * This method doesn't expect any request body.
   */
  getCurrentUser(params?: GetCurrentUser$Params, context?: HttpContext): Observable<UserDetails> {
